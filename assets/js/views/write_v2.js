// 편지 작성/수정 — PRD v2 §7.2
import { $, $$, esc, toast, dialog, currentMonthId, periodLabel, copyText } from '../util.js?v=20260906_pdf_v35';
import { getSettings, saveDraft, loadDraft, clearDraft } from '../store.js?v=20260906_pdf_v35';
import { emptyBody, openLetter, countPhotos } from '../letters.js?v=20260906_pdf_v35';
import { checkPassword } from '../crypto.js?v=20260906_pdf_v35';
import { extractDriveId, verifyDriveImage, loadDriveImage, SHARE_HELP, SHARE_CONFIRM, PHOTO_LIMIT_HINT } from '../drive_v2.js?v=20260906_pdf_v35';
import { letterHTML, loadLetterImages, bindPrayers, printLetter } from '../render_v2.js?v=20260906_pdf_v35';
import { shareLink } from '../github.js?v=20260906_pdf_v35';
import { navigate } from '../router.js?v=20260906_pdf_v35';
...
// ── 배포 — 브라우저는 저장소에 직접 쓰지 않는다(github.js?v=20260906_pdf_v35 writeBlocked).
