// 설정 화면 — PRD v2 §7.4
import { $, esc, toast } from '../util.js?v=1788590728';
import { getSettings, saveSettings } from '../store.js?v=1788590728';
import { extractDriveId } from '../drive_v2.js?v=1788590728';
